      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        {messages.length > 0 ? (
          ...
          <div className="flex justify-center items-end">
            <span className="w-fit bg-neutral-200 p-4 rounded-lg text-xl font-medium">
              Welcome! Type below to start messaging
            </span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="flex gap-2 w-full">
            <input
              ...
              className="flex-1 w-full p-2 border border-neutral-300 rounded-2xl bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-blue-300"
            />
            <button
              type="submit"
