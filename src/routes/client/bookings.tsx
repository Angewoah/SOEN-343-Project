...
import { createNewConversation } from "../../modules/network/service";
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          {booking.event?.timeslot ? (
                            <p>
                              {formatDate(
                                booking.event.timeslot.start_time ?? undefined
                              )}
                            </p>
                          ) : (
                    ...
                    <td className="p-4 border-b">
                      {booking.type === "attendee" ? (
                        <div className="flex flex-col gap-1">
                          <button
                            className="font-medium rounded-md p-2 bg-neutral-300 hover:bg-neutral-200 transition-colors hover:cursor-pointer "
                            onClick={() =>
                              handleContactOrganizer(
                                booking.event!.organizer_id!,
                                booking.event_id!,
                                booking.event?.title!
                              )
                            }
                          ...
                          {status === "pending" && (
                            <div className="flex space-x-2">
                              <button
                                ...
                                onClick={() =>
                                  handleSpeakerResponse(booking.id, true)
                                }
                              >
                                Accept
                              </button>
                              <button
                                ...
                                onClick={() =>
                                  handleSpeakerResponse(booking.id, false)
                                }
                              >
                                Decline
                              </button>
                          ...
                          {status === "confirmed" && (
                            <div className="space-y-2">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleReconsiderSpeaking(booking.id)
                                }
                              >
                                Cancel Appearance
                              </button>
